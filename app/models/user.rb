class User < ApplicationRecord
  ...
  has_many :requested_follow_requests, class_name: 'FollowRequest', foreign_key: 'requester_id'
  has_many :approved_follow_requests, class_name: 'FollowRequest', foreign_key: 'approver_id'
